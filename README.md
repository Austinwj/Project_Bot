...
* The program is set in the UK 🇬🇧 daily at 06:30 to post the weather conditions (the default address is Glasgow). Functions and others can be modified by referring to ananas.
